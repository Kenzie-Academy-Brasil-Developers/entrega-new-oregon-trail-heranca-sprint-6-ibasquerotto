# language: pt
    ...
    Funcionalidade: Carroça
        Como cocheiro
        Devo controlar a capacidade de Travelers na carroça
        E cuidar do estado de saúde dos Travelers
    ...
    Contexto:
        ...
        E o Traveler de nome <name> que está com saúde <isHealthy> e tem <food> refeições
            | name   | isHealthy | food |
            | Sergio | true      | 1    |
            | Simone | true      | 1    |
            | Samuel | true      | 1    |
    ...
    Cenário: Revelar assentos disponíveis na carroça.
        Dada a entrada do Traveler "Sergio"
        E a entrada do Traveler "Simone"
        E a entrada do Traveler "Samuel"
    ...
    Cenário: Um viajante consegue subir a bordo
        ...
        E a entrada do Traveler "Simone"
        E a entrada do Traveler "Samuel"
        Quando o Traveler "Sandra" tentar subir a bordo
        Então ele deverá ser adicionada à lista de Travelers
